...
class SubitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subitem" do
    assert_difference("Subitem.count") do
      post subitems_url, params: { subitem: { item_id: @subitem.item_id, name: @subitem.name } }
    end
  ...
  test "should update subitem" do
    patch subitem_url(@subitem), params: { subitem: { item_id: @subitem.item_id, name: @subitem.name } }
